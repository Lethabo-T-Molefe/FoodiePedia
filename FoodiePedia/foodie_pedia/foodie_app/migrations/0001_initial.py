# Generated by Django 5.0.3 on 2024-06-21 13:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foodie_app.ingredient')),
                ('recipe_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foodie_app.recipe')),
            ],
        ),
        migrations.CreateModel(
            name='User_Ingredient',
            fields=[
                ('user_ingredient_id', models.IntegerField(primary_key=True, serialize=False)),
                ('ingredient_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foodie_app.ingredient')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('favourite_recipe_id', models.IntegerField(primary_key=True, serialize=False)),
